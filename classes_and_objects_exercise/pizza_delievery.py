class PizzaDelivery:
    ...
    def make_order(self):
        self.ordered = True
        sorted_ingredient_quantity = ", ".join(f"{k}: {v}" for k, v in self.ingredients.items())
        return f"You've ordered pizza {self.name} prepared with {sorted_ingredient_quantity} and the price will be {self.price}lv."
